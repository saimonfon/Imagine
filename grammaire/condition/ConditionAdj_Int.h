#ifndef CONDITION_ADJ_INT_HEADER
#define CONDITION_ADJ_INT_HEADER
...
class ConditionAdj_Int : public Condition{
public:
	...
	ConditionAdj_Int(int i,std::string att_i, int j, std::string att_j);
	int i;
	int j;
	std::string att_i;
	std::string att_j;
